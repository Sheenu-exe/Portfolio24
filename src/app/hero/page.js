    ...
    return(
        <div id="home" className="flex sm:flex-row flex-col h-screen overflow-x-hidden">
            ...
            <div className="middle h-full flex flex-col gap-3 justify-center">
                ...
                <p className="text-gray-400 sm:m-0 mx-3">Designing User-Centric Experiences with Precision and Creativity</p>
                ...
                <a className="  px-2 py-2  text-black bg-white border rounded-lg" href="tel:+918668369314">See My Work</a>
                </div>
            </div>
            <div className="right sm:h-full sm:w-[6vw] flex justify-center items-center">
                <ul className="flex w-full justify-around sm:flex-col sm:gap-5 ">
                    <li className="w-12 h-12 bg-white text-black flex justify-center items-center border rounded-full"><a title="X (Twitter)" href="https://twitter.com/Sheenu_exe"><RiTwitterXFill className="text-3xl"/></a></li>
